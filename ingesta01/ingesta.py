"""ingesta01 | ms-residentes (MySQL) -> S3.

PLACEHOLDER. Debe extraer el 100% de los registros de edificios, unidades y residentes
...
def main() -> None:
    ...
    # TODO: 2. Conectar a MySQL.
    # TODO: 3. Extraer el 100% de los registros de edificios, unidades y residentes (paginado por lotes).
